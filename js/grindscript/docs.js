...
arrays: {
    ...
    content: `
        ...
        <pre>numbers = [1, 2, 3];          // Числовой массив
names = ["Аня", "Боря"];    // Строковый массив
mixed = [true, "текст", 5]; // Смешанный массив</pre>

        <h3>Основные операции</h3>
        <pre>arr = [10, 20, 30]
arr[0] = 100       // Изменение элемента
len = arr.length   // Длина массива (макс. 50 элементов)
arr.push(40)       // Добавить в конец</pre>

        <h3>Ограничения</h3>
        <ul>
            <li>Максимальная длина массива: 50 элементов</li>
            <li>Только одномерные массивы</li>
            <li>Доступные методы: push, pop, length</li>
            <li>Не поддерживаются: slice, map, filter</li>
        </ul>
